...
* Full name: `\PAMI\Message\Action\DongleSendUSSDAction`
...
```php
public __construct(string $device, string $ussd): void
```
...
|-----------|------------|------------------------------|
| `$device` | **string** | Device name (like dongle01). |
| `$ussd`   | **string** | USSD to send.                |
