...
* Full name: `\PAMI\Message\Action\ChangeMonitorAction`
...
```php
public __construct(string $channel, string $filename): void
```
...
| `$filename` | **string** | Absolute path to target filename. |
