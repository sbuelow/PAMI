...
* Full name: `\PAMI\Message\Action\BridgeAction`
...
```php
public __construct(string $channel1, mixed $channel2, bool $tone = false): void
```
...
|-------------|------------|--------------------------------|
| `$channel1` | **string** | Channel1                       |
| `$channel2` | **mixed**  |                                |
| `$tone`     | **bool**   | Play courtesy tone to Channel2 |
