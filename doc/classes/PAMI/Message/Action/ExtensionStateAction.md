...
* Full name: `\PAMI\Message\Action\ExtensionStateAction`
...
```php
public __construct(string $exten, string $context): void
```
...
|------------|------------|-------------------------|
| `$exten`   | **string** | Extension to check for. |
| `$context` | **string** | Context for extension.  |
