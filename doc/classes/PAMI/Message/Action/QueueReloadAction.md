...
* Full name: `\PAMI\Message\Action\QueueReloadAction`
...
```php
public __construct(string $queue = false, bool $members = false, bool $rules = false, bool $parameters = false): void
```
...
| `$members`    | **bool**   | Reload members.    |
| `$rules`      | **bool**   | Reload rules.      |
| `$parameters` | **bool**   | Reload parameters. |
