...
* Full name: `\PAMI\Message\Action\GetConfigAction`
...
```php
public __construct(string $filename, bool $category = false): void
```
...
|-------------|------------|------------------------------------------|
| `$filename` | **string** | Configuration filename (e.g.: foo.conf). |
| `$category` | **bool**   | Category in configuration file.          |
