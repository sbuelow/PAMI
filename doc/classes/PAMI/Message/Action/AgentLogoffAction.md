...
* Full name: `\PAMI\Message\Action\AgentLogoffAction`
...
```php
public __construct(string $agent, string $soft = false): void
```
...
| `$soft`   | **string** | Set to true to not hangup existing calls. |
