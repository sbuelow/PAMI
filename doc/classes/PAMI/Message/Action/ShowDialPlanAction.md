...
* Full name: `\PAMI\Message\Action\ShowDialPlanAction`
...
```php
public __construct(string $context = false, string $extension = false): void
```
...
|--------------|------------|--------------------------------------|
| `$context`   | **string** | Show a specific context (optional)   |
| `$extension` | **string** | Show a specific extension (optional) |
