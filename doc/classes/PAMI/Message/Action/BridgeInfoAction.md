...
* Full name: `\PAMI\Message\Action\BridgeInfoAction`
...
```php
public __construct(string $bridgeUniqueid): void
```
...
|-------------------|------------|------------------------------------------------------------------|
| `$bridgeUniqueid` | **string** | The unique ID of the bridge about which to retrieve information. |
