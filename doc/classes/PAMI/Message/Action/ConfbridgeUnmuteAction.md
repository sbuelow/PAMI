...
ConfbridgeUnmute action message.

PHP Version 5

***

* Full name: `\PAMI\Message\Action\ConfbridgeUnmuteAction`
...
```php
public __construct(string $channel, string $conference): void
```
...
|---------------|------------|-----------------------------|
| `$channel`    | **string** | Channel to be unmuted.      |
| `$conference` | **string** | Conference on which to act. |
