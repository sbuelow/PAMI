...
* Full name: `\PAMI\Message\Event\RTCPReceivedEvent`
...
```php
public getReceptionReports(): string
```
...
```php
public getHighestSequence(): string
```
...
```php
public getSequenceNumberCycles(): string
```
