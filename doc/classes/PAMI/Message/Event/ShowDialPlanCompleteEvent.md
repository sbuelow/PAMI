...
* Full name: `\PAMI\Message\Event\ShowDialPlanCompleteEvent`
...
```php
public getListExtensions(): string
```
...
```php
public getListPriorities(): string
```
