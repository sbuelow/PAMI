...
* Full name: `\PAMI\Message\Event\TransferEvent`
...
```php
public getTransferMethod(): string
```
...
```php
public getTargetChannel(): string
```
...
```php
public getTargetUniqueID(): string
```
...
```php
public getTransferExten(): string
```
...
```php
public getTransferContext(): string
```
